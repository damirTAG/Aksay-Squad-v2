...
function show_comments($comments, $parent_id = -1) {
    ...
    foreach ($comments as $comment) {
        if ($comment['parent_id'] == $parent_id) {
            ...
            $html .= '
            <div class="comment" id="paginated-list" aria-live="polite">
                <div>
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <textarea name="content" placeholder="Оставить коммент здесь" required></textarea>
...
if (isset($_GET['page_id'])) {
    ...
    if (isset($_POST['name'], $_POST['content'])) {
        ...
        exit('Комментарий успешно оставлен! Обновите страницу');
    }
...
<div class="comment_header">
    <span class="total"><?=$comments_info['total_comments']?> Комментария</span>
    <a href="#" class="write_comment_btn" data-comment-id="-1">Оставить коммент</a>
</div>
